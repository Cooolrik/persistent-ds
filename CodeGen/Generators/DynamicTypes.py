...
def DynamicTypes_inl():
	...
	lines.append('            }')
	lines.append('        ctLogError << "Invalid typeCombo parameter { " << (int)typeCombo.data_type << " , " << (int)typeCombo.container_type << " } " << ctLogEnd;')
	...
	lines.append('            {')
	lines.append('            ctLogError << "Invalid parameter, data must be a pointer to existing type" << ctLogEnd;')
	...
	lines.append('            {')
	lines.append('            ctLogError << "Invalid parameter, dest and src must be pointers to existing types" << ctLogEnd;')
	lines.append('            return false;')
	lines.append('            }')
	lines.append('        const _dynamicTypeClass *ta = _findTypeClass( { dataType, containerType } );')
	lines.append('        if( !ta )')
	...
	lines.append('            {')
	lines.append('            ctLogError << "Invalid parameter, dataA and dataB must be pointers to existing types" << ctLogEnd;')
	lines.append('            return false;')
	lines.append('            }')
	lines.append('        const _dynamicTypeClass *ta = _findTypeClass( { dataType, containerType } );')
	lines.append('        if( !ta )')
